...
export default function Index() {
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-end h-16">
            <div className="flex items-center space-x-4 p-2">
              <a
                href="https://github.com/RoyHgstrm/SketchGuess"
                target="_blank"
    ...
    <footer className="fixed bottom-0 left-0 right-0 bg-gray-900/50 backdrop-blur-sm py-3 border-t border-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
